...
public class HanaFaultSender implements Runnable
{
   public void run()
   {
     try
 ...
 //   catch (Exception ex) {
  ...
  private String[] getSignatureFromHanaDB()
  {
    ...
    // StringBuilder  sqlsb = new StringBuilder("SELECT FAULT_SIGNATURE FROM \"8EDD06F21D6243FD92CA9FD2F2FED431\".\"aicoin.db::SAP_HANA_BLOCKCHAIN.FAULT\" WHERE FAULT_AIBC_STATUS = 'I'");
    PreparedStatement prepareStatement = hanaConnection.prepareStatement("SELECT FAULT_SIGNATURE FROM \"8EDD06F21D6243FD92CA9FD2F2FED431\".\"aicoin.db::SAP_HANA_BLOCKCHAIN.FAULT\" WHERE FAULT_AIBC_STATUS = 'I'");
